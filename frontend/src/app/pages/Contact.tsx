    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="relative h-64 overflow-hidden hero-preserve">
        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-black text-[#FAFAFA] mb-2">
                Contact Us
              </h1>
              <p className="text-[#9CA3AF]">
                T.N Palayam, Gobichettipalayam, Erode District, Tamil Nadu
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            <div>
              ...
              <p className="text-[#6B7280] text-sm">
                Reach out for admissions, general enquiries, or visit us at our
                campus in Gobichettipalayam.
              </p>
            </div>
            ...
            {[
              ...
              },
              {
                ...
                title: "Phone Numbers",
                lines: [
                  "+91 98942 65545 (Principal/General)",
                  "+91 97894 56753 (Transport: Mr. Laksmiganthan)",
                ],
              },
              {
                icon: Mail,
              ...
              <div
                key={i}
                className="bg-[#111111] border border-[#D4AF37]/10 rounded-xl p-5 flex gap-4 hover:border-[#D4AF37]/30 transition-all duration-300"
              >
                ...
                <div>
                  <div className="text-[#D4AF37] font-bold text-xs uppercase tracking-wider mb-1">
                    {item.title}
                  </div>
                  {item.lines.map((line, li) =>
                    line.includes("@") ? (
                      <a
                        key={li}
                        href={`mailto:${line}`}
                        className="block text-[#9CA3AF] text-sm hover:text-[#D4AF37] transition-colors duration-200"
                      >
                        {line}
                      </a>
                    ) : line.startsWith("+") ? (
                      ...
                      <div key={li} className="text-[#9CA3AF] text-sm">
                        {line}
                      </div>
                    ),
                  )}
            ...
            >
              ...
              <div>
                ...
                <div className="text-[#6B7280] text-xs">
                  Chat directly with our admission team
                </div>
              </div>
            </a>
          </motion.div>
          ...
          >
            <div className="bg-[#111111] border border-[#D4AF37]/10 rounded-2xl p-8">
              <h2 className="text-xl font-black text-[#FAFAFA] mb-6">
                Send Us a Message
              </h2>
              {submitted ? (
                <div className="py-16 text-center">
                  ...
                  <h3 className="text-2xl font-black text-[#FAFAFA] mb-2">
                    Message Sent!
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#0A0A0A] border border-[#D4AF37]/20 text-[#FAFAFA] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#D4AF37] transition-colors duration-200 placeholder-[#4B5563] resize-none"
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h2 className="text-2xl font-black text-[#FAFAFA] mb-6">
            Find Us on the Map
          </h2>
          ...
          <p className="text-[#6B7280] text-sm mt-3 text-center">
            Annai J.K.K. Sampoorani Ammal Polytechnic College, T.N Palayam,
